...
`, illustration: '/illustrations/bunnys-cozy-night/bunnys-cozy-night-ending.png' },
    ...
    slug: 'dreamy-cloud-adventure',
    title: 'Dreamy Cloud Adventure',
    description: 'Felix the fluffy fox built a cozy pillow fort under a big tree. Closing his eyes, he imagined floating on a soft cloud.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🦊',
    themes: ['Imagination', 'Dreams', 'Bedtime'],
    tags: ['imagination', 'dreams', 'bedtime', 'cozy', 'adventure'],
    characters: ['Felix', 'Bella'],
    keywords: ['dreamy cloud adventure', 'early-readers bedtime story'],
    coverImage: '/illustrations/dreamy-cloud-adventure/dreamy-cloud-adventure-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little town, there lived a fluffy fox named Felix. One sunny afternoon, Felix decided to build a soft pillow fort in his favorite spot under the big, shady tree. He gathered all his fluffy pillows and warm blankets. As he snuggled inside, he closed his eyes and let his imagination soar.`, illustration: '/illustrations/dreamy-cloud-adventure/dreamy-cloud-adventure-cover.png' },
      { text: `Suddenly, Felix felt himself floating on a big, fluffy cloud! The cloud was soft and warm, like his cozy fort. "Where will this take me?" he wondered. With a gentle breeze, Felix found himself surfing on the cloud across the bright blue sky.` },
      { text: `He waved hello to the birds singing sweet songs, and they chirped back, inviting him to join their happy tune. Felix laughed with joy. The wind whispered stories of faraway lands where flowers danced and stars twinkled. ` },
      { text: `As he floated higher, Felix spotted a rainbow arching across the sky. He decided to slide down the rainbow, landing softly in a field of fluffy marshmallow flowers. Each flower smelled sweet and tickled his nose, making him giggle.`, illustration: '/illustrations/dreamy-cloud-adventure/dreamy-cloud-adventure-scene.png' },
      { text: `Then, Felix met a friendly bunny named Bella. She wore a tiny hat made of leaves and had the gentlest smile. Together, they danced among the flowers, twirling and laughing until the sky began to turn soft shades of pink and gold.` },
      { text: `As the sun began to set, Felix felt a warm hug from the gentle evening breeze. He knew it was time to return home. With a gentle swoosh, the cloud lifted him back to his pillow fort under the big tree. Felix opened his eyes, still feeling the magic of the cloud adventure.` },
      { text: `With a yawn, he snuggled deeper into his soft pillows, feeling cozy and safe. And as he drifted off to sleep, Felix dreamed of new adventures waiting for him on the clouds, floating softly into the night. `, illustration: '/illustrations/dreamy-cloud-adventure/dreamy-cloud-adventure-ending.png' },
    ],
  },
    {
    slug: 'dreamy-cloud-surfing',
    title: 'The Dreamy Cloud Surfing',
    description: 'Lily loved to imagine surfing on fluffy clouds. One night, as she snuggled in her warm bed, she wished to ride the clouds.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    coverImage: '/illustrations/dreamy-cloud-surfing/dreamy-cloud-surfing-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little town, lived a sweet girl named Lily. Every night, before she drifted off to sleep, she imagined fluffy clouds dancing in the sky. One evening, as she snuggled in her soft, warm bed, she whispered, "I wish I could surf on those clouds!"  `, illustration: '/illustrations/dreamy-cloud-surfing/dreamy-cloud-surfing-cover.png' },
      { text: `As soon as her eyes closed, a gentle breeze floated into her room. Suddenly, she found herself on a soft, white cloud, floating high above the ground. The cloud felt like a big, cozy pillow, wrapping her in warmth.  ` },
      { text: `Lily giggled as the cloud glided and swirled through the air. She saw bright stars twinkling and the moon smiling down at her. "Let's surf, fluffy cloud!" she cheered. The cloud responded with a soft puff, and off they went, soaring like a feather through the starry night.  ` },
      { text: `With every twist and turn, Lily felt the cool night air on her face and the soft cloud beneath her. She watched as gentle rainbows arched across the sky, making her heart flutter with joy. "This is so much fun!" she laughed, her voice mixing with the whispers of the wind.  ` },
      { text: `They floated over sleepy towns, where tiny lights glimmered like fireflies. "Look at all the sweet dreams below!" Lily said with a smile. The cloud danced and swayed, making Lily feel light and free, as if she could reach out and touch the stars.  `, illustration: '/illustrations/dreamy-cloud-surfing/dreamy-cloud-surfing-scene.png' },
      { text: `As the night grew quieter, the cloud began to slow down. "Time to cozy up, Lily," it whispered. The soft cloud gently wrapped around her, cradling her like a fluffy blanket.  ` },
      { text: `With her eyes growing heavy, Lily snuggled deeper. She could still see the stars twinkling above, but her heart felt warm and sleepy. "Goodnight, fluffy cloud," she murmured, drifting into a dream-filled sleep, ready for more adventures tomorrow.  ` },
      { text: `And so, with a soft sigh, Lily fell asleep, her dreams filled with clouds and stars, cozy and warm, just like her blanket.  
...
'Close your eyes, Milo,' she said with a smile. 'Tomorrow will bring more sunshine and fun!' ` },
    ...
    {
    slug: 'bunnys-dreamy-adventure',
    title: 'Bunny\'s Dreamy Adventure',
    description: 'In a cozy burrow, a fluffy bunny named Benny was ready for sleep. He whispered, \'It\'s time for my adventure in Dreamland!\' With a deep breath, he closed his eyes and floated on a soft cloud.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    readingMinutes: 5,
    emoji: '🐰',
    themes: ['Dreams', 'Friendship', 'Bedtime'],
    tags: ['bunny', 'dreams', 'friendship', 'bedtime', 'imagination'],
    characters: ['Benny'],
    keywords: ['bunnys dreamy adventure', 'early-readers bedtime story'],
    coverImage: '/illustrations/bunnys-dreamy-adventure/bunnys-dreamy-adventure-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little burrow, there lived a fluffy bunny named Benny. Benny loved to snuggle in his soft, warm bed made of the fluffiest hay. As the sun began to set, Benny's little eyes grew heavy, and he whispered, 'It's time for my adventure in Dreamland!'`, illustration: '/illustrations/bunnys-dreamy-adventure/bunnys-dreamy-adventure-cover.png' },
      { text: `Benny closed his eyes and took a deep breath, feeling the warm, gentle breeze of the evening. Suddenly, he found himself floating on a fluffy cloud, soft as cotton candy! 'Oh, what a wonderful dream!' Benny giggled as he surfed the clouds, feeling the cool, gentle air on his fur.` },
      { text: `As he floated higher, Benny spotted a rainbow slide spiraling down. With a joyful hop, he slid down the rainbow, feeling the tickle of colors all around him. Each color made him giggle even louder—red was warm, blue was cool, and yellow made him feel bright and sunny!` },
      { text: `At the bottom of the slide, Benny discovered a magical pillow fort made of the softest pillows and blankets. He crawled inside and found his friends—Silly Squirrel, Playful Puppy, and Wise Owl—waiting for him. 'Join us for a cozy story!' said Wise Owl, fluffing a big, soft pillow.`, illustration: '/illustrations/bunnys-dreamy-adventure/bunnys-dreamy-adventure-scene.png' },
      { text: `The friends snuggled together in the pillow fort, wrapped in the warmth of friendship. Wise Owl told them tales of twinkling stars and dancing fireflies, while the gentle night wrapped around them like a soft, cozy blanket. Benny felt so safe and warm as they listened together, the soft sounds of their laughter echoing in the night.` },
      { text: `As the stories ended and the moon shone brightly outside, Benny yawned a big, sleepy yawn. 'I think it’s time for more dreams,' he said softly. He snuggled deeper into the pillows, feeling the soft fabric against his fur.` },
      { text: `With a gentle sigh, Benny closed his eyes again, drifting off into a deeper sleep, ready for more adventures in the magical world of dreams. Goodnight, sweet Benny, until tomorrow’s dreams come true.`, illustration: '/illustrations/bunnys-dreamy-adventure/bunnys-dreamy-adventure-ending.png' },
    ],
  },
    {
    slug: 'tilly-the-tired-turtle',
    title: 'Tilly the Tired Turtle',
    description: 'In a cozy pond lived Tilly the turtle, her shiny shell sparkling in the sun. After a day of splashing with fish and frogs, Tilly felt very sleepy.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    tags: ['turtle', 'bedtime', 'cozy', 'animals', 'gentle'],
    characters: ['Tilly'],
    keywords: ['tilly the tired turtle', 'early-readers bedtime story'],
    coverImage: '/illustrations/tilly-the-tired-turtle/tilly-the-tired-turtle-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little pond, there lived a soft, gentle turtle named Tilly. Tilly had a shiny, green shell that sparkled in the warm sunlight. Every day, Tilly loved to swim and play with her friends, the little fish and froggy friends. They splashed and laughed, creating ripples in the water that danced like tiny twinkling stars.`, illustration: '/illustrations/tilly-the-tired-turtle/tilly-the-tired-turtle-cover.png' },
      { text: `As the sun began to set, painting the sky with shades of pink and purple, Tilly felt a gentle yawn escape her mouth. "Oh, I am so sleepy," she sighed softly. The water felt warm and inviting, and the soft sounds of the pond made her feel cozy.` },
      { text: `Tilly slowly paddled to the sandy shore, where the grass was soft and inviting. She found her favorite spot, a little patch of soft moss that felt like a warm blanket. Tilly nestled down into the moss, feeling its fluffy softness wrap around her like a hug. The air was calm and quiet, filled with the soothing sounds of chirping crickets and rustling leaves.`, illustration: '/illustrations/tilly-the-tired-turtle/tilly-the-tired-turtle-scene.png' },
      { text: `With her little eyes getting heavier, Tilly took a deep breath, smelling the sweet scent of flowers nearby. The stars began to twinkle above her, and the moon cast a gentle silver light over the pond. Tilly closed her eyes, letting the peaceful sounds of the night lull her into a cozy dream.` },
...
The gentle leaves continued to sway, and the night was peaceful and quiet, just like Sammy's dreams.`, illustration: '/illustrations/sloths-snuggly-night/sloths-snuggly-night-cover.png' },
    ...
    {
    slug: 'lunas-dreamy-journey',
    title: 'Luna\'s Dreamy Journey',
    description: 'Luna was a sweet girl who loved dreaming of magical adventures. One night, the glowing Moon invited her on a journey.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🌈',
    themes: ['Bedtime'],
    tags: ['dream journey', 'moon visit', 'star catching', 'bedtime story', 'cozy adventure'],
    characters: ['Luna', 'Moon'],
    keywords: ['lunas dreamy journey', 'early-readers bedtime story'],
    coverImage: '/illustrations/lunas-dreamy-journey/lunas-dreamy-journey-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little house, there lived a sweet girl named Luna. Every night, as the stars twinkled softly in the sky, she would dream of magical adventures. One night, as she snuggled into her warm, fluffy bed, a gentle glow filled her room. It was the Moon, shining bright and inviting!`, illustration: '/illustrations/lunas-dreamy-journey/lunas-dreamy-journey-cover.png' },
      { text: `'Come with me, Luna!' the Moon whispered, its voice like a soft lullaby. With a twinkling smile, Luna climbed onto the Moon’s silvery beams. Up, up they floated, past sleepy clouds and twinkling stars.` },
      { text: `As they flew, Luna felt the soft breeze on her cheeks and the warmth of stardust all around. 'Look over there!' said the Moon, pointing to a cluster of bright stars. They were dancing in a beautiful starry ballet! Luna clapped her hands in delight as they spun and twirled, leaving trails of sparkles behind.` },
      { text: `Next, the Moon took her to a field of fluffy clouds, where they landed softly. The clouds were like cotton candy, and Luna giggled as she bounced on them. 'This is so cozy!' she exclaimed, feeling warm and safe.`, illustration: '/illustrations/lunas-dreamy-journey/lunas-dreamy-journey-scene.png' },
      { text: `Suddenly, a gentle star floated down and whispered, 'Would you like to catch a star, Luna?' With a big smile, she nodded. The star sparkled brightly and told her to reach out her hands. With a soft whoosh, she caught the star, holding it close. It felt warm and glowed gently, filling her heart with happiness.` },
      { text: `After a night of laughter, dancing, and catching stars, the Moon said, 'It’s time to go home, sweet Luna.' With a soft sigh, Luna agreed. As they floated back, she felt cozy and loved.` },
      { text: `Finally, she snuggled back into her bed, holding the warm star close to her heart. 'Goodnight, Moon,' she whispered, her eyes slowly closing. As she drifted off to sleep, Luna dreamed of her magical adventure in the sky, surrounded by love and soft, twinkling stars. 

And so, Luna slept peacefully, waiting for the next night's adventure in her dreams.`, illustration: '/illustrations/lunas-dreamy-journey/lunas-dreamy-journey-ending.png' },
    ],
  },
    {
    slug: 'lunas-starry-night',
    title: 'Luna\'s Starry Night',
    description: 'In a cozy house lived a fluffy cat named Luna. Every night, she looked at the sparkling stars outside her window.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    readingMinutes: 5,
    emoji: '🐱',
    themes: ['Dreams', 'Bedtime'],
    tags: ['bedtime story', 'magical adventure', 'cats', 'dreams', 'stars'],
    characters: ['Luna'],
    keywords: ['lunas starry night', 'early-readers bedtime story'],
    coverImage: '/illustrations/lunas-starry-night/lunas-starry-night-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little house, there lived a soft, fluffy cat named Luna. Each night, when the moon rose and the stars twinkled, Luna loved to gaze out of her window. The world outside sparkled like fairy dust, and Luna dreamed of adventures.`, illustration: '/illustrations/lunas-starry-night/lunas-starry-night-cover.png' },
      { text: `One special night, as the silver moonlight bathed her fur, Luna felt a gentle breeze. It whispered, "Come with me, dear Luna! Let’s visit the stars!" With a soft leap, Luna found herself floating up, up, up, among the clouds. The stars danced around her, glowing bright and warm, like little lanterns in the sky.` },
      { text: `Luna giggled, feeling soft stardust tickle her whiskers. She stretched her paws, and to her surprise, she could catch the stars! One by one, she gently gathered them in her tiny paws, each star shining with a lovely light.` },
      { text: `“Let’s share this magic!” a sweet star chimed. Luna nodded, and together they sprinkled the starlight down to the earth below, lighting up the dark corners of the world. The flowers in the garden sparkled like diamonds, and the trees shimmered with a warm golden glow.`, illustration: '/illustrations/lunas-starry-night/lunas-starry-night-scene.png' },
      { text: `As Luna played with the stars, she felt cozy and happy. The night air was soft, and the sweet scent of flowers filled her nose. Soon, she began to feel sleepy. The stars twinkled softly like lullabies, wrapping her in a blanket of warmth.` },
...
And in that dreamy place, everything was soft, warm, and oh-so-cozy, just like Whiskers liked it. Goodnight, little kitten, goodnight.`, illustration: '/illustrations/counting-cozy-kittens/counting-cozy-kittens-ending.png' },
    ...
    slug: 'counting-cozy-clouds',
    title: 'Counting Cozy Clouds',
    description: 'In a sleepy town, little Leo the bear was ready for bed. He cuddled under his fuzzy blanket and looked out at the night sky.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🧸',
    themes: ['Bedtime', 'Dreams'],
    tags: ['counting', 'bedtime', 'bears', 'clouds', 'dreams'],
    characters: ['Leo', 'One'],
    keywords: ['counting cozy clouds', 'early-readers bedtime story'],
    coverImage: '/illustrations/counting-cozy-clouds/counting-cozy-clouds-cover.png',
    pages: [
      { text: `Once upon a time, in a gentle, sleepy town, little Leo the bear was getting ready for bed. The moon shone softly through his window, lighting up his cozy room. Leo loved to count, so tonight he decided to count fluffy clouds before saying goodnight.  `, illustration: '/illustrations/counting-cozy-clouds/counting-cozy-clouds-cover.png' },
      { text: `He snuggled under his warm, fuzzy blanket and looked out at the sky. "One, two, three!" he counted the clouds drifting by. Each cloud was soft and white like a cotton ball. He imagined lying on them, feeling cozy and safe.  ` },
      { text: `"Four, five, six!" The clouds began to change shapes. One looked like a big, friendly bunny, and another like a smiling star. Leo giggled softly, feeling the warmth of his blanket wrap around him.  ` },
      { text: `"Seven, eight, nine!" The clouds danced together, swirling and twirling in the night sky. They glowed gently under the moonlight, making the world feel quiet and peaceful. Leo took a deep breath, smelling the sweet scent of his teddy bear beside him.  `, illustration: '/illustrations/counting-cozy-clouds/counting-cozy-clouds-scene.png' },
      { text: `As he counted higher, his eyes grew heavy. "Ten!" he whispered, feeling a soft yawn escape his lips. The clouds began to fade, drifting off to their cloud beds. Leo felt sleepy and cozy.  ` },
      { text: `He cuddled his teddy bear tight, whispering, "Goodnight, fluffy clouds!" He closed his eyes, the warmth of his blanket cradling him softly. Outside, the stars twinkled like little friends, watching over him. Leo felt safe and loved, and soon he drifted off to dreamland, counting cozy clouds in his slumber.  ` },
      { text: `And with that, little Leo the bear fell fast asleep, dreaming sweet dreams beneath the starlit sky.`, illustration: '/illustrations/counting-cozy-clouds/counting-cozy-clouds-ending.png' },
    ],
  },
    {
    slug: 'whiskers-cozy-nap',
    title: 'Whiskers\' Cozy Nap',
    description: 'In a warm little house, a sleepy kitten named Whiskers was ready for a nap. With soft, fluffy fur, he curled up in his favorite sunny spot.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    readingMinutes: 5,
    emoji: '🐱',
    themes: ['Bedtime', 'Sleep', 'Animals'],
    tags: ['kitten', 'bedtime', 'cozy', 'sleep', 'animals'],
    characters: ['Whiskers'],
    keywords: ['whiskers cozy nap', 'early-readers bedtime story'],
    coverImage: '/illustrations/whiskers-cozy-nap/whiskers-cozy-nap-cover.png',
    pages: [
      { text: `Once upon a time, in a warm little house, there lived a sleepy kitten named Whiskers. Whiskers had soft, fluffy fur that felt like a cloud. Every evening, as the sun dipped low in the sky, he would curl up in his favorite sunny spot by the window. `, illustration: '/illustrations/whiskers-cozy-nap/whiskers-cozy-nap-cover.png' },
      { text: `One cozy afternoon, Whiskers yawned a big, fluffy yawn. His little eyes blinked slowly as he stretched his tiny paws. It was time for a nap! The room was quiet, with only the gentle rustle of leaves outside. ` },
      { text: `Whiskers found his soft bed, a warm blanket that smelled like home. He snuggled into the blanket, feeling safe and snug. The blanket wrapped around him like a warm hug. ` },
      { text: `As he lay there, a soft breeze danced through the window, carrying the sweet scent of flowers. Whiskers could almost hear the whisper of the wind saying, “It’s time to sleep, little one.” ` },
      { text: `With a gentle purring sound, Whiskers closed his eyes. The world became a soft blur around him. He imagined chasing butterflies in a sunny meadow, feeling the grass tickle his paws. `, illustration: '/illustrations/whiskers-cozy-nap/whiskers-cozy-nap-scene.png' },
      { text: `Every now and then, he would twitch his little ears, dreaming of playful adventures. But soon, the dreams turned to clouds, and Whiskers floated softly away into dreamland. ` },
      { text: `The room was filled with a warm glow as the stars began to twinkle outside. Whiskers snuggled deeper into his cozy blanket, feeling safe and warm. With one last yawn, he drifted off to sleep, dreaming of happy things and adventures yet to come.` },
      { text: `As the moon shone brightly, Whiskers slept soundly, wrapped in love and warmth, ready for another day of cuddles and play. And so, in the quiet little house, the sleepy kitten drifted away into a world of dreams.`, illustration: '/illustrations/whiskers-cozy-nap/whiskers-cozy-nap-ending.png' },
    ],
  },
    {
    slug: 'bennys-moonlight-adventure',
    title: 'Benny\'s Moonlight Adventure',
    description: 'Benny the bear woke up to a magical night with a bright silver moon. Excited, he stepped outside and felt the soft grass tickle his paws.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🐻',
    themes: ['Bedtime'],
    tags: ['bedtime story', "children's book", 'magical adventure', 'cozy', 'nighttime'],
    characters: ['Benny', 'Twinkle'],
    keywords: ['bennys moonlight adventure', 'early-readers bedtime story'],
    coverImage: '/illustrations/bennys-moonlight-adventure/bennys-moonlight-adventure-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little forest, there lived a soft and cuddly bear named Benny. One starry night, when the silver moon shone brightly, Benny peeked out of his warm, fuzzy den. The night felt magical, and Benny's heart fluttered with excitement. He wanted to see the moon up close!`, illustration: '/illustrations/bennys-moonlight-adventure/bennys-moonlight-adventure-cover.png' },
      { text: `As Benny stepped outside, he felt the soft grass tickling his paws and a gentle breeze whispering secrets of the night. The trees swayed, and the stars twinkled like sparkling diamonds above. 'I will visit the moon!' Benny declared, his eyes shining with wonder.` },
      { text: `With a gentle hop, Benny closed his eyes and imagined he was soaring through the sky. He felt light as a feather, floating among fluffy clouds. The moon welcomed him with a warm glow, and Benny could see all the soft, shimmering stars around.` },
      { text: `On the moon, everything was soft and cozy. Benny bounced on the silvery surface, giggling as he danced with the twinkling stars. They shared stories of dreams and laughter, and Benny felt so happy and free. He even found a star named Twinkle, who liked to play hide-and-seek!`, illustration: '/illustrations/bennys-moonlight-adventure/bennys-moonlight-adventure-scene.png' },
      { text: `After a while, Benny felt a gentle tug. It was time to go back home. Benny waved goodbye to his new friends and promised to visit again. As he floated back down to the forest, he felt the warm earth beneath his paws.` },
      { text: `Benny snuggled back into his den, wrapping his fuzzy blanket around him. The night was now quiet, and the moon shone softly through his window. With a big yawn, Benny whispered, 'Thank you, moon, for the adventure.' He closed his eyes, feeling warm and cozy, drifting off to sleep with dreams of stars and moonlight dancing in his heart.`, illustration: '/illustrations/bennys-moonlight-adventure/bennys-moonlight-adventure-ending.png' },
    ],
  },
    {
    slug: 'counting-cozy-bears',
    title: 'Counting Cozy Bears',
    description: 'In a cozy forest lived a little bear named Benny. As the sun set, Benny counted his bedtime routine.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🐻',
    themes: ['Bedtime', 'Bedtime Routine'],
    tags: ['counting', 'bedtime', 'bears', 'routine', 'cozy'],
    characters: ['Benny'],
    keywords: ['counting cozy bears', 'early-readers bedtime story'],
    coverImage: '/illustrations/counting-cozy-bears/counting-cozy-bears-cover.png',
    pages: [
      { text: `Once upon a time, in a soft, warm forest, there lived a little bear named Benny. Benny loved to count everything around him. As the sun began to set, Benny decided it was time to count his bedtime routine.`, illustration: '/illustrations/counting-cozy-bears/counting-cozy-bears-cover.png' },
      { text: `Benny started with one warm bath. He splashed in the water and giggled as the bubbles floated around him like little clouds. It felt so cozy and soft! After his bath, he counted two fluffy towels, one pink and one blue, as he wrapped himself up snugly.` },
      { text: `Next, Benny counted three sweet honey pots that sat on his shelf. He took a tiny taste from each one, enjoying the warm, sweet flavor. "Yum!" he said with a smile.` },
      { text: `Then Benny prepared for bed by counting four soft pillows. He fluffed each one until they were just right. They felt so soft against his furry head. Benny climbed into his little bed, which was covered with a warm blanket that smelled like vanilla.` },
      { text: `As Benny tucked himself in, he looked out of his window and counted five twinkling stars in the night sky. They sparkled brightly, like tiny jewels. "Goodnight, stars," Benny whispered softly, feeling their warmth from afar.`, illustration: '/illustrations/counting-cozy-bears/counting-cozy-bears-scene.png' },
      { text: `Finally, he closed his eyes and took a deep breath, counting to six as he imagined all the adventures he would have in his dreams. One... two... three... four... five... six. With each number, he felt his body become more relaxed. ` },
      { text: `The gentle sounds of the forest wrapped around Benny like a soft hug. The crickets chirped a sweet lullaby, and the wind whispered through the trees. Benny smiled and snuggled deeper into his blanket, feeling warm and cozy.` },
      { text: `And soon, very soon, little Benny drifted off to sleep, dreaming of counting more delightful things in his next adventure. The forest was quiet, and all was well.

Goodnight, Benny! Goodnight, stars! Goodnight, cozy dreams!`, illustration: '/illustrations/counting-cozy-bears/counting-cozy-bears-ending.png' },
    ],
  },
    {
    slug: 'moonlit-garden-dreams',
    title: 'Moonlit Garden Dreams',
    description: 'In a cozy garden under the moonlight, a puppy named Benny gets ready for sleep. As he strolls through the soft grass, he greets the sleepy bunny and wishes the froggies sweet dreams by the pond.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🐶',
    themes: ['Bedtime', 'Nature', 'Dreams'],
    tags: ['bedtime', 'nature', 'garden', 'puppy', 'dreams'],
    characters: ['Benny'],
    keywords: ['moonlit garden dreams', 'early-readers bedtime story'],
    coverImage: '/illustrations/moonlit-garden-dreams/moonlit-garden-dreams-cover.png',
    pages: [
      { text: `In a cozy little garden, under the soft glow of the moon, all the flowers, trees, and little creatures were getting ready for sleep. The sweet scent of jasmine filled the air, wrapping around everything like a warm blanket. `, illustration: '/illustrations/moonlit-garden-dreams/moonlit-garden-dreams-cover.png' },
      { text: `A friendly puppy named Benny lived in this garden. As the sun dipped below the horizon, Benny watched the sky turn a lovely shade of twilight blue. 'It's time for moonlit adventures,' he thought. ` },
      { text: `Benny trotted through the garden, feeling the soft, cool grass beneath his paws. He sniffed at the daisies, and they whispered sweet lullabies in the gentle night breeze. The stars twinkled above, like tiny little diamonds scattered across a velvet sky. ` },
      { text: `Benny saw a sleepy bunny nestled in the clover patch. 'Goodnight, little bunny,' he whispered. The bunny twitched its nose and snuggled deeper into the soft clover, happy and warm. ` },
      { text: `Next, Benny wandered to the pond, where the quiet water sparkled under the moonlight. He saw the frogs resting on lily pads, their soft croaks fading into sleepy hums. 'Sweet dreams, froggies,' he called softly. `, illustration: '/illustrations/moonlit-garden-dreams/moonlit-garden-dreams-scene.png' },
      { text: `Finally, Benny found his favorite spot—a little nook beneath a big old tree where the branches danced softly with the wind. He curled up on a pile of soft leaves, feeling cozy and safe. ` },
      { text: `The garden was quiet now, filled with the soft sounds of nature settling down for the night. Benny listened to the gentle rustle of leaves and the distant hoot of an owl. He closed his eyes, letting the calmness of the garden wash over him like a warm wave. ` },
      { text: `As Benny drifted off to sleep, he dreamed of bright flowers blooming under the moonlight and all the lovely friends he would see when the sun rose again. With a soft sigh, Benny fell into the sweetest dreams, ready for a peaceful night's rest in his moonlit garden.`, illustration: '/illustrations/moonlit-garden-dreams/moonlit-garden-dreams-ending.png' },
    ],
  },
    {
    slug: 'snuggly-kittens-dream',
    title: 'Snuggly Kitten\'s Dream',
    description: 'In a cozy cottage, a fluffy kitten named Whiskers settled down by the window as the sun set. His soft fur felt like a warm blanket.',
    ageGroup: 'early-readers',
    ageLabel: 'Ages 5-7',
    ageRange: [5, 7],
    readingTime: '5 min',
    ...
    emoji: '🏰',
    themes: ['Dreams', 'Bedtime'],
    tags: ['kitten', 'bedtime story', 'gentle', 'cozy', 'dreams'],
    characters: ['Whiskers'],
    keywords: ['snuggly kittens dream', 'early-readers bedtime story'],
    coverImage: '/illustrations/snuggly-kittens-dream/snuggly-kittens-dream-cover.png',
    pages: [
      { text: `Once upon a time, in a cozy little cottage at the edge of the forest, lived a soft and snuggly kitten named Whiskers. Whiskers had the fluffiest fur, as white as snow and as warm as a cozy blanket. Every evening, after a day of playing and exploring, Whiskers would curl up in his favorite spot—a soft pillow by the window.`, illustration: '/illustrations/snuggly-kittens-dream/snuggly-kittens-dream-cover.png' },
      { text: `As the sun began to set, casting a golden glow over the trees, Whiskers felt his eyelids growing heavy. He glanced outside and saw the twinkling stars beginning to sparkle in the deep blue sky. The gentle sound of the leaves rustling lulled him into a sleepy state.` },
      { text: `Whiskers took a deep, soft breath, inhaling the sweet scent of blooming flowers from the garden. He wrapped his tiny paws around his squishy toy mouse, feeling its soft texture against his fur. "Tonight, I will have the sweetest dreams," he thought.` },
      { text: `As he nestled deeper into his pillow, Whiskers imagined a magical place—a castle made of fluffy clouds and warm sunshine. He could hear the giggles of playful kittens dancing through the halls of this dream castle. They played hide-and-seek among the clouds and chased each other with gentle purrs and soft meows.`, illustration: '/illustrations/snuggly-kittens-dream/snuggly-kittens-dream-scene.png' },
      { text: `In his dream, he met a gentle puppy whose fur was as golden as the sun. Together, they explored the castle, sliding down soft, fluffy slides and jumping over marshmallow pillows. Every corner of the castle was cozy and warm, just like Whiskers’ little cottage.` },
      { text: `As the moon rose higher in the sky, Whiskers cuddled even closer to his pillow. He was feeling so very sleepy. The gentle night breeze whispered sweet lullabies through the window, wrapping around him like a soft blanket.` },
